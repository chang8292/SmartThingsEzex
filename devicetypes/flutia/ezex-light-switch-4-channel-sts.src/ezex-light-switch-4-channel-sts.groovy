/**
 * eZEX C2O Light Switch (4 Channel, E220-KR4N0Z0-HA) - v1.0.2
 *
 ...
 */
metadata {
    definition(name: "eZEX Light Switch-4 Channel (STS)", namespace: "flutia", author: "flutia", vid: "generic-switch", ocfDeviceType: "oic.d.light") {
        capability "Actuator"
        capability "Switch"
        ...
        fingerprint profileId: "0104", deviceId: "0100", inClusters: "0000, 0003, 0004, 0006", model: "E220-KR4N0Z0-HA"
    }
